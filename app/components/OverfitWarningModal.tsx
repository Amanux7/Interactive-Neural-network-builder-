        ...
        <div className="p-6">
          ...
          <div className="flex gap-2.5">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-xl text-[12px] font-semibold shadow-sm hover:from-blue-600 hover:to-indigo-700 transition-all"
            >
              <ShieldCheck size={13} />
              Add Dropout & Train
            </button>
